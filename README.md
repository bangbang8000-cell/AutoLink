...
[![Version](https://img.shields.io/badge/version-3.4.2-blue)](https://github.com/bangbang8000-cell/AutoLink/releases)
...
- **Windows**：`AutoLink-Setup-3.4.2-win.exe`（NSIS 安装包）
- **macOS**：`AutoLink-3.4.2-mac-x64.dmg` / `AutoLink-3.4.2-mac-arm64.dmg`
- **Linux**：`AutoLink-3.4.2-linux.AppImage` / `.deb`
