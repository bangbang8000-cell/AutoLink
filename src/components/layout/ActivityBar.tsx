...
import {
  FolderOpen, Zap, Wrench, Network, Settings, PanelLeftClose, PanelLeft, Library,
} from 'lucide-react'
...
const activities: ActivityItem[] = [
  ...
  { id: 'device_library', icon: <Library size={20} />, labelKey: 'menu.deviceLibrary', shortcut: 'Ctrl+Shift+L' },
