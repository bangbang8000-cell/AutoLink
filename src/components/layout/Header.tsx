...
export function Header() {
  ...
  return (
    <header className="h-9 flex items-center justify-between shrink-0 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 select-none">
      <div className="flex items-center gap-3 px-3">
        <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">AutoLink</span>
      </div>
